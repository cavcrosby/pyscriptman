...
class TestBackupUnit:
    ...
    def test_backup_requests_connectionerror_handled(self, unit_test_setup, capsys, monkeypatch):
    ...
    def test_backup_requests_httperror_handled(self, unit_test_setup, capsys, monkeypatch):
